...
og_image: "/assets/img/media-reposts/media-phoneharness/img-003-97e512d1cd.png"
source_links:
  - label: "机器之心原文"
...
{% include figure.html path="assets/img/media-reposts/media-phoneharness/img-003-97e512d1cd.png" class="img-fluid rounded z-depth-0" zoomable=true alt="PhoneHarness architecture from the original media report" caption="Representative figure from the original media report." %}
