---
layout: distill
title: "When AI Agents Buy Air Conditioners: A Shenzhen TV Interview with Benyou Wang"
date: 2026-07-05
description: "An edited English Q&A with Shenzhen TV on what a viral Midea PortaSplit story reveals about AI agents, loop engineering, agent societies, and the human ability to organize digital labor."
tags: ai-agents loop-engineering media-interview human-ai-collaboration
...
toc:
  - name: 1. Why an Air Conditioner Became an AI Agent Story
  - name: 2. The Future Skill Is Organizing AI
  - name: 3. Platforms Will Face Agents, Not Only Users
  - name: 4. AI Is Both an Equalizer and an Amplifier
  - name: 5. Experience Will Be Redefined
  - name: 6. Mature Agents Need Fallback Ability
...
- Can inputs and outputs be digitized?
- Can the agent access the necessary systems and data?
- Can success be defined?
- Is the task frequent enough to justify investment?
- Can errors be detected and intercepted?
- Is there a business owner responsible for process redesign?
- Are there permission, audit, rollback, and human takeover mechanisms?
