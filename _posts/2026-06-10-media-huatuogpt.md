...
og_image: "/assets/img/media-roundup-2026/huatuogpt-overview.png"
source_links:
  - label: "机器之心原文"
...
{% include figure.html path="assets/img/media-roundup-2026/huatuogpt-overview.png" class="img-fluid rounded z-depth-0" zoomable=true alt="HuatuoGPT overview from the original media report" caption="Representative figure from the original media report." %}
